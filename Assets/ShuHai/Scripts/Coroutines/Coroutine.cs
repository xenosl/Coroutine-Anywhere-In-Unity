...
namespace ShuHai.Unity.CoroutineAnywhere
{
    ...
    public sealed class Coroutine : IYield
    {
        ...
        /// <summary>
        ///     Update all started coroutines with specified <see cref="CoroutineAnywhere.UpdateMethod" />. This method is called
        ...
        /// <summary>
        ///     Indicates whether the current coroutine instance is done.
        /// </summary>
        ...
        public static IYieldAdapter GetYieldAdapter(Type type, bool useBaseOnNotFound = true)
        {
            ...
            if (!useBaseOnNotFound)
            {
                ...
                return yieldAdapters.TryGetValue(type, out adapter) ? adapter : null;
            }
